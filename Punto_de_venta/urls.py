...
urlpatterns = [
	url(r'^$', views.bienvenida, name='bienvenida'),
	url(r'^register/$', views.registro, name='registro'),
	url(r'^login/$', views.login, name='login'),
	url(r'^logout/$', views.logout, name='logout'),

	url(r'^inicio/$', views.ptoventa_list, name='pagina_inicio'),
	...
	url(r'^caja/sesion/(?P<pk>\d+)/$', views.caja_sesion, name='caja_sesion'),
	url(r'^caja/cerrar/$', views.cerrar_caja, name='cerrar_caja'),
	url(r'^caja/operacion/$', views.operacion_caja, name='operacion_caja'),
		
	url(r'^reporte/$', views.reporte, name='reporte'),
	url(r'^reporte/venta/$', views.reporte_venta, name='reporte_venta'),
	url(r'^reporte/exportar$', views.reporte_excel, name='reporte_excel'),
	url(r'^reporte/pdf$', views.reporte_pdf, name='reporte_pdf'),
	url(r'^reporte/pdf/venta/(?P<pk>\d+)/$', views.reporte_pdf_venta, name='reporte_pdf_venta'),
